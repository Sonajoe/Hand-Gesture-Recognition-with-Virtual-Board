...
def airoboard(session_start_time, name, image_load):
    #print(image)
    ...
    while True:
        ...
        open_cv_image = numpy.array(image_load)
        ith = open_cv_image[:, :, ::-1].copy()
        ith = cv2.resize(ith, (300, 400))
        img[130:530, 0:300] = ith # on our frame we are setting our JPG image acc to H,W of jpg images
        ...
        cv2.rectangle(img, (0, 720), (600, 660), (0, 0, 0), -1)
        # cv2.rectangle(img, pt1=(0, 720), pt2=(600, 660), color=(0, 0, 0), thickness= 1)
        cv2.putText(img, str(name), (50, 690), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 255), 2)
        cv2.putText(img, "Session_Started: " + str(name) + " " + str(session_start_time), (50, 710),
